                ...
                <main>
                        ...
                        if ( isset( $_GET['message'] ) ) {
                                ...
                                switch ( $message ) {
                                        ...
                                        case 'cleared':
                                                if ( 'logs' === $current_tab ) {
                                                        $notice_html = "<div class='bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-6 rounded-md'><p><strong>" . esc_html__( 'Logs cleared successfully.', 'clickrank-ai' ) . "</strong></p></div>";
                                                }
                                                break;
                                        case 'error':
                                                if ( 'logs' === $current_tab ) {
                                                        $notice_html = "<div class='bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-6 rounded-md'><p><strong>" . esc_html__( 'Unable to clear logs. Please try again.', 'clickrank-ai' ) . "</strong></p></div>";
                                                }
                                                break;
                                }
                        ...
                        if ( isset( $_GET['sync_status'] ) && 'home' === $current_tab ) {
                                ...
                                if ( 'success' === $status ) {
                                        $notice_html = "<div class='bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-6 rounded-md'><p><strong>" . esc_html__( 'Local sync completed successfully!', 'clickrank-ai' ) . "</strong> " . esc_html__( 'Review the Logs tab for details.', 'clickrank-ai' ) . "</p></div>";
                                } elseif ( 'error' === $status ) {
                                        $notice_html = "<div class='bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-6 rounded-md'><p><strong>" . esc_html__( 'Local sync failed.', 'clickrank-ai' ) . "</strong> " . esc_html__( 'Please check the Logs tab for more details.', 'clickrank-ai' ) . "</p></div>";
                                }
