...
$local_mode_enabled = (bool) get_option( 'clickrank_ai_local_mode', true );
...
<form id="cr-settings-form" action="options.php" method="post">
        ...
        <div class="bg-white shadow-sm rounded-lg mb-8">
                <div class="p-6 border-b border-gray-200 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                                <h2 class="text-xl font-bold text-gray-800"><?php esc_html_e( 'Automation Mode', 'clickrank-ai' ); ?></h2>
                                <p class="text-gray-600 mt-2"><?php esc_html_e( 'Local mode keeps every feature available without connecting to an external service.', 'clickrank-ai' ); ?></p>
                        </div>
                        <label for="clickrank_ai_local_mode" class="relative inline-flex items-center cursor-pointer">
                                <input type="hidden" name="clickrank_ai_local_mode" value="0">
                                <input type="checkbox" id="clickrank_ai_local_mode" name="clickrank_ai_local_mode" value="1" <?php checked( $local_mode_enabled, true ); ?> class="sr-only peer">
                                <div class="w-14 h-7 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                </div>
                <div class="p-6 bg-gray-50 border-t border-gray-200">
                        <p class="text-sm text-gray-600"><i class="fas fa-info-circle text-blue-500 mr-2"></i><?php esc_html_e( 'Keep this enabled for the best offline experience. Disabling local mode will pause scheduled syncs and automations.', 'clickrank-ai' ); ?></p>
                </div>
        </div>
        ...
        <div class="bg-white shadow-sm rounded-lg">
                ...
                <div class="p-6 bg-gray-50 border-t border-gray-200 rounded-b-lg flex justify-end">
                        <button type="submit" name="submit" id="submit-modules" class="inline-flex justify-center items-center gap-2 rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                ...
                                <?php esc_html_e( 'Save Settings', 'clickrank-ai' ); ?>
                        </button>
                </div>
        </div>
</form>

<div id="danger-zone" class="mt-8 bg-white shadow-sm rounded-lg">
