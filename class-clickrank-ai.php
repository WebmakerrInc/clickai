...
class ClickRank_AI {
        ...
        public function health_check() {
                ...
                $tables = [
                        $wpdb->prefix . 'clickrank_ai_logs',
                        $wpdb->prefix . 'clickrank_ai_seo_data',
                ];
                ...
                if ( empty( $missing_tables ) ) {
                        ...
                        ClickRank_AI_Logger::debug( 'Health check passed (local mode).' );
                        return;
                }

                ClickRank_AI_Logger::warning( 'Health check detected missing tables: ' . implode( ', ', $missing_tables ) );
        }
